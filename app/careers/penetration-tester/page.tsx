...
export default function ApplyPenetrationTester() {
  return (
    <main className="min-h-screen bg-background py-16 px-4 flex flex-col items-center">
      <div className="max-w-xl w-full mx-auto bg-white dark:bg-background rounded-xl shadow-lg p-8 border border-primary/10">
        <h1 className="text-3xl font-bold text-primary mb-4 text-center">Apply: Penetration Tester</h1>
        ...
        <form className="space-y-6" onSubmit={e => {
          ...
          if (typeof window !== "undefined") {
            ...
            submissions.push({
              type: "Job Application: Penetration Tester",
              name,
              email,
              linkedin,
              fit,
