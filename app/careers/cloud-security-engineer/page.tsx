...
export default function ApplyCloudSecurityEngineer() {
  return (
    <main className="min-h-screen bg-background py-16 px-4 flex flex-col items-center">
      <div className="max-w-xl w-full mx-auto bg-white dark:bg-background rounded-xl shadow-lg p-8 border border-primary/10">
        <h1 className="text-3xl font-bold text-primary mb-4 text-center">Apply: Cloud Security Engineer</h1>
        <p className="text-base text-muted-foreground mb-6 text-center">Noida, India | Full-time</p>
        <form className="space-y-6" onSubmit={e => {
          ...
          if (typeof window !== "undefined") {
            ...
            submissions.push({
              type: "Job Application: Cloud Security Engineer",
              name,
              email,
              linkedin,
              fit,
